...
class Ostore_Admin {
	...
	private function intro() {
		...
		<h2 class="nav-tab-wrapper">
			...
			<a class="nav-tab <?php if ( isset( $_GET['tab'] ) && $_GET['tab'] == 'video_document' ) echo 'nav-tab-active'; ?>" href="<?php echo esc_url( admin_url( add_query_arg( array( 'page' => 'ostore-welcome', 'tab' => 'video_document' ), 'themes.php' ) ) ); ?>">
				<?php echo  esc_html__(  'Video Document', 'ostore' ); ?>
			</a>
	...
	public function video_document_screen() {
		...
		<div class="wrap about-wrap">
			...
			<div style="margin-top:50px;" >
				<iframe width="100%" height="615" src="https://www.youtube.com/embed/LRiZbczYdHo" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
			</div>
