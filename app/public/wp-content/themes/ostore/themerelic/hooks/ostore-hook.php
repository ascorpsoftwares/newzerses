...
if ( ! function_exists( 'ostore_hlp_hot_deal' ) ) {    
    function ostore_hlp_hot_deal($hot_deal_product_args,$categories_cat_id) {
        ...
        if( $term = get_term_by( 'id', $categories_cat_id, 'product_cat' ) ){
        ...
        <div class="row">
            <?php
                ...
                if( $slider_cat_1_name ){
                    ...
                    $thumbnail_id = get_term_meta( $slider_1_cat_id, 'thumbnail_id', true );
            ...
            <!-- Second Category -->
                <?php
                    ...
                    if( $slider_cat_2_name ){
                        ...
                        $thumbnail_id = get_term_meta( $slider_2_cat_id, 'thumbnail_id', true );
                        $slider_2_image = wp_get_attachment_url($thumbnail_id);
                ...
                ?>
                <div class="col-md-12 col-sm-6 " >
                    <a href="<?php echo esc_url($slider_cat_2_url);  ?>" class="ostore-bottom-banner-img second-child">
                        <div class="overimg"> 
...
if ( ! function_exists( 'ostore_tab_layout_option' ) ) {
	function ostore_tab_layout_option( $tab_product_default,$tab_multiple_category_id,$tab_product_multiple_select) {	
        ...
        ?>
        <div class="title-bg ostore-tabs">
        ...
        <?php 
            ...
            ?>
            <li class="<?php if($count == 1){ ?>active <?php }$count++; ?>" cat_link ="<?php echo esc_attr(get_category_link($tab_key)); ?>" ><a  href="#<?php echo esc_attr( $term->slug ); ?>" data-toggle="tab" aria-expanded="false"><?php echo esc_html( $term->name ); ?></a></li>
