...
class ostore_service_box_widget_area extends WP_Widget {
    ...
    **/
    public function form($instance) {
        $defaults = array(
            'ostore_service_box_1_title'		=> esc_html__( 'Free Shipping Worldwide', 'ostore' ),
            'ostore_service_box_1_desc'			=> esc_html__( 'Diam augue augue in fusce voluptatem', 'ostore' ),
            'ostore_service_box_1_icon'			=> esc_html__( 'fa fa-users', 'ostore' ),

            'ostore_service_box_2_title'		=> esc_html__( 'Money Back Guarantee', 'ostore' ),
            'ostore_service_box_2_desc'			=> esc_html__( 'Diam augue augue in fusce voluptatem', 'ostore' ),
            'ostore_service_box_3_icon'			=> esc_html__( 'fa fa-home', 'ostore' ),

            'ostore_service_box_3_title'		=> esc_html__( '24/7 Help Center', 'ostore' ),
            'ostore_service_box_3_desc'			=> esc_html__( 'Diam augue augue in fusce voluptatem', 'ostore' ),
            'ostore_service_box_3_icon'			=> esc_html__( 'fa fa-coffee', 'ostore' ),
