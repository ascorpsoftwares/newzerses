...
function ostore_scripts() {
	...
	wp_enqueue_script( 'match-height', get_template_directory_uri() . '/assets/js/jquery.matchHeight.js', array('jquery'), esc_attr( $theme_version ), false );
	
	wp_enqueue_script( 'ostore-main', get_template_directory_uri() . '/assets/js/main.js', array('jquery', 'jquery-ui-tooltip'), esc_attr( $theme_version ), true );
...
function ostore_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			'name' => esc_attr__( 'Elementor', 'ostore'),
			'slug' => 'elementor',
			'required' => false,
		),
    );
...
function ostore_widget_theme_support() {
    remove_theme_support( 'widgets-block-editor' );
}
add_action( 'after_setup_theme', 'ostore_widget_theme_support' );
