...
if( ! function_exists( 'di_ecommerce_nav_fallback' ) ) {
	...
	function di_ecommerce_nav_fallback( $args ) {
		...
		$output .= '<li class="menu-item menu-item-type-custom"><a class="nav-link" href="#">'. __( 'Shop', 'di-ecommerce' ) .'</a></li>';

		$output .= '<li class="menu-item menu-item-type-custom"><a class="nav-link" href="#">'. __( 'Blog', 'di-ecommerce' ) .'</a></li>';

		$output .= '<li class="menu-item menu-item-type-custom"><a class="nav-link" href="#">'. __( 'Responsive', 'di-ecommerce' ) .'</a></li>';

		$output .= '<li class="menu-item menu-item-type-custom"><a class="nav-link" href="#">'. __( 'SEO Friendly', 'di-ecommerce' ) .'</a></li>';

		$output .= '<li class="menu-item menu-item-type-custom"><a class="nav-link" href="#">'. __( 'Customizable', 'di-ecommerce' ) .'</a></li>';

		$output .= '<li class="menu-item menu-item-type-custom"><a class="nav-link" href="#">'. __( 'Page Builder', 'di-ecommerce' ) .'</a></li>';
