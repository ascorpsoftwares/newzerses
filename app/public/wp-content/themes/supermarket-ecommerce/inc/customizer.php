...
function supermarket_ecommerce_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting( 'supermarket_ecommerce_show_site_title_color', array(
		'default' => '',
		'sanitize_callback' => 'sanitize_hex_color'
	));
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'supermarket_ecommerce_show_site_title_color', array(
		'label' => 'Title Color',
		'section' => 'title_tagline',
	)));
	...
	$wp_customize->add_setting( 'supermarket_ecommerce_show_site_tagline_color', array(
		'default' => '',
		'sanitize_callback' => 'sanitize_hex_color'
	));
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'supermarket_ecommerce_show_site_tagline_color', array(
		'label' => 'Tagline Color',
		'section' => 'title_tagline',
	)));
	...
	$wp_customize->add_section('supermarket_ecommerce_product_section',array(
		...
		'description'	=> __('<b>Note : </b>Add content here.','supermarket-ecommerce'),
		'panel' => 'supermarket_ecommerce_panel_id',
	));
   ...
   $wp_customize->add_control('supermarket_ecommerce_product_section_padding',array(
	...
	$wp_customize->add_setting('supermarket_ecommerce_footer_link',array(
		'default'	=> 'https://www.luzuk.com/themes/free-wordpress-ecommerce-theme/',
		'sanitize_callback'	=> 'sanitize_text_field'
	));	
	$wp_customize->add_control('supermarket_ecommerce_footer_link',array(
		'label'	=> __('Footer Link','supermarket-ecommerce'),
		'section'	=> 'supermarket_ecommerce_footer',
		'setting'	=> 'supermarket_ecommerce_footer_link',
		'type'		=> 'text'
	));

	$wp_customize->add_setting('supermarket_ecommerce_footer_copy',array(
		'default'	=> 'Ecommerce WordPress Theme By Luzuk',
		'sanitize_callback'	=> 'sanitize_text_field'
	));	
	...
	$wp_customize->add_setting('supermarket_ecommerce_copyright_padding',array(
		'default' => '',
		'sanitize_callback'	=> 'supermarket_ecommerce_sanitize_float'
 	));
 	$wp_customize->add_control('supermarket_ecommerce_copyright_padding',array(
		'type' => 'number',
		'label' => __('Copyright Top Bottom Padding','supermarket-ecommerce'),
		'section' => 'supermarket_ecommerce_footer',
	));
