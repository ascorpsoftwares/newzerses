<?php 
	...
	$supermarket_ecommerce_slider_hide_show = get_theme_mod('supermarket_ecommerce_slider_hide_show',false);
	if( $supermarket_ecommerce_slider_hide_show == true){
		$supermarket_ecommerce_custom_style .=' .page-template-custom-home-page #inner-pages-header {';
			$supermarket_ecommerce_custom_style .=' display:none;';
		$supermarket_ecommerce_custom_style .=' }';
	}

	$supermarket_ecommerce_show_site_title_color = get_theme_mod('supermarket_ecommerce_show_site_title_color');

	if ( $supermarket_ecommerce_show_site_title_color != '') {
		$supermarket_ecommerce_custom_style .=' .logo h1 a, .logo p.site-title a {';
			$supermarket_ecommerce_custom_style .=' color:'.esc_attr($supermarket_ecommerce_show_site_title_color).';';
		$supermarket_ecommerce_custom_style .=' }';
	}

	$supermarket_ecommerce_show_site_tagline_color = get_theme_mod('supermarket_ecommerce_show_site_tagline_color');

	if ( $supermarket_ecommerce_show_site_tagline_color != '') {
		$supermarket_ecommerce_custom_style .=' .logo p {';
			$supermarket_ecommerce_custom_style .=' color:'.esc_attr($supermarket_ecommerce_show_site_tagline_color).';';
		$supermarket_ecommerce_custom_style .=' }';
	}

	// Copyright padding
	$supermarket_ecommerce_copyright_padding = get_theme_mod('supermarket_ecommerce_copyright_padding');
	if( $supermarket_ecommerce_copyright_padding != ''){
		$supermarket_ecommerce_custom_style .=' .copyright {';
			$supermarket_ecommerce_custom_style .=' padding-top: '.esc_attr($supermarket_ecommerce_copyright_padding).'px; padding-bottom: '.esc_attr($supermarket_ecommerce_copyright_padding).'px;';
		$supermarket_ecommerce_custom_style .=' }';
	}