...
<a class="skip-link screen-reader-text" href="#content"  >
	<?php _e( 'Skip to content', 'popular-ecommerce' ); ?></a>
	<div>
	<!-- Header -->
	...
	<div id="header-wrap" class="header-wrap-2">
		    <!-- Header Logo -->
			<?php
			$header_otions =  get_theme_mod('header_menu_ecommerce_lite_nav_options','nav-header-2');
					...
					<div class="row">
						...
						<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
							<div class="pull-right clearfix">
								...
								<?php if( $header_otions == 'nav-header-1' ): ?>
								<div class="menu-bar">
						...
						<div class="navbar-header">
							<div class="container">
								<button type="button" class="navbar-toggle pull-left" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
									<span class="sr-only"><?php esc_html_e('Toggle navigation','popular-ecommerce'); ?></span>
