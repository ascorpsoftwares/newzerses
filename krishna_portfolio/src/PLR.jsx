...
import { Sparkles, Flower, Moon, Sun, Heart, Quote, ArrowRight, Mail, Phone, MapPin } from "lucide-react";
              ...
              <div className="bg-gray-800 p-8 rounded-2xl">
                ...
                <div className="space-y-4">
                  <div className="flex items-center">
                    ...
                    <span>Dr. Chanda.healing@gmail.com</span>
                  </div>
                  <div className="flex items-center">
        ...
        <div className="max-w-6xl mx-auto px-6 text-center">
          ...
          <div className="border-t border-gray-800 pt-6">
            <p className="text-gray-500">
              © {new Date().getFullYear()} Dr. Chanda Past Life Regression. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
